...
class _PeminjamanScreenState extends State<PeminjamanScreen> {
          ...
          Wrap(
            ...
            children: [
              _outlinedBtn(
                ...
                'Barang Ready',
                _hijau,
                () => _showDialogBarangReady(provider),
              ),
              _outlinedBtn(
  ...
  void _showDialogBarangReady(InventoryProvider provider) {
    final barangTersedia = provider.barangTersedia.where((b) => b.tersedia > 0).toList();
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.inventory_2_rounded, color: _hijau, size: 22),
            ),
        ...
        content: SizedBox(
          ...
          child: barangTersedia.isEmpty
              ? const Padding(
                  padding: EdgeInsets.symmetric(vertical: 32),
                  child: Center(
                    child: Text('Saat ini belum ada barang inventaris yang ready/tersedia.'),
                  ),
                )
              : SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: barangTersedia.map((b) {
                      return Container(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      if (b.kategori != null && b.kategori!.isNotEmpty)
                                        Container(
                                          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                                          decoration: BoxDecoration(
